...
<table>
  ...
  <tbody>
    <tr>
      <td rowspan="2" align="center"><b><img src="launcher/assets/icons/chip.png" width="16" height="16" title="Chip" alt="Chip"/> Intel XScale PXA255 (ARM)</b><br/><sub>ARMv5TE</sub></td>
      <td>
    ...
    <tr>
      <td rowspan="4" align="center"><b><img src="launcher/assets/icons/chip.png" width="16" height="16" title="Chip" alt="Chip"/> Intel SA-1110 (ARM)</b><br/><sub>StrongARM</sub></td>
      <td>
    ...
    <tr>
      <td align="center"><b><img src="launcher/assets/icons/chip.png" width="16" height="16" title="Chip" alt="Chip"/> Intel SA-1100 (ARM)</b><br/><sub>StrongARM</sub></td>
      <td>
    ...
    <tr>
      <td align="center"><b><img src="launcher/assets/icons/chip.png" width="16" height="16" title="Chip" alt="Chip"/> ARM720T (ARM)</b><br/><sub>ARMv4T</sub></td>
      <td>
    ...
    <tr>
      <td align="center"><b><img src="launcher/assets/icons/chip.png" width="16" height="16" title="Chip" alt="Chip"/> NEC VR5500 (MIPS)</b><br/><sub>MIPS IV</sub></td>
      <td>
        <img src="launcher/assets/icons/pda.png" width="16" height="16" title="PDA" alt="PDA"/> <b>NEC Rockhopper SG2_VR5500</b><br/>
        <img src="launcher/assets/icons/os_ce.png" width="16" height="16" title="Windows CE 6" alt="Windows CE 6"/> Windows CE 6
      </td>
      <td><img src="launcher/assets/icons/display.png" width="16" height="16" title="Display" alt="Display"/> <img src="launcher/assets/icons/mouse.png" width="16" height="16" title="Mouse" alt="Mouse"/> <img src="launcher/assets/icons/keyboard.png" width="16" height="16" title="Keyboard" alt="Keyboard"/></td>
    </tr>
    <tr>
      <td align="center"><b><img src="launcher/assets/icons/chip.png" width="16" height="16" title="Chip" alt="Chip"/> TI OMAP 3530 (ARM)</b><br/><sub>Cortex-A8</sub></td>
      <td>
    ...
    <tr>
      <td rowspan="2" align="center"><b><img src="launcher/assets/icons/chip.png" width="16" height="16" title="Chip" alt="Chip"/> Samsung S3C2410 (ARM)</b><br/><sub>ARM920T</sub></td>
      <td>
    ...
    <tr>
      <td align="center"><b><img src="launcher/assets/icons/chip.png" width="16" height="16" title="Chip" alt="Chip"/> Freescale i.MX31L (ARM)</b><br/><sub>ARM1136</sub></td>
      <td>
